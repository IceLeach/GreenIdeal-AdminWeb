...
import { Button, DatePicker, Drawer, Form, Input, InputNumber, message, Radio, Select, Upload } from 'antd';
    ...
    >
      ...
      >
        ...
        <div className={styles.row}>
          ...
          >
            <DatePicker showTime showHour showMinute style={{ width: '100%' }} />
          </Form.Item>
          <Form.Item
            name='endTime'
            label='变更结束时间'
        ...
        >
          <Upload
            ...
            fileList={[{ uid: 'rc-upload-1650783545343-3', name: 'file.zip', type: 'application/x-zip-compressed', status: 'done', size: 13161205, url: 'http://www.baidu.com/xxx.zip' }]}
