      ...
      >
        <Tabs>
          <Tabs.TabPane tab="基本信息" key="1" forceRender={true}>
            ...
            <Form.Item name="hardware" label="硬件配置">
              <Input />
            </Form.Item>
            <Form.Item name="software" label="软件配置">
              <Input />
            </Form.Item>
            ...
            <Form.Item label="尺寸(CM)" required>
              <span>长</span>
              <Form.Item
                name="length"
            ...
            <Form.Item label={`实物照片(${pictureCount}/4)`} required>
              <Upload
            ...
            <Form.Item label={`文件资料(${fileCount}/6)`}>
              <Upload
                listType="picture-card"
                multiple
                maxCount={6}
          ...
          <Tabs.TabPane tab="服务信息" key="2" forceRender={true}>
            <Form.Item name="purchaseType" label="购买类型">
              <Radio.Group>
            ...
            <Form.Item name="productionDate" label="出厂日期">
              <DatePicker style={{ width: '100%' }} />
            </Form.Item>
            <Form.Item name="guaranteeDate" label="维保到期">
              <DatePicker style={{ width: '100%' }} />
            </Form.Item>
            <Form.Item name="guaranteeRange" label="维保范围">
              <Select>
